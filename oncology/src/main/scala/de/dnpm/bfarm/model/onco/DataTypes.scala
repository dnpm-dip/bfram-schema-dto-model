...
/*
 * DISCLAIMER:
 * Not my idea, this object semantically identical to a normal Coding but with field "key" instead" of "code".
 * The reported issue asking to change this to a normal Coding for consistency with other coded values
 * was ignored (https://github.com/BfArM-MVH/MVGenomseq_KDK/issues/4).
 * Hence the custom DTO to conform to the upstream API specs.
 */
...
/*
 * DISCLAIMER:
 * Not my idea to have this JSON representation of a Codings extended with another field, e.g. "date",
 * {
 *   "code": "...",
 *   "display": "...",
 *   ...
...
/*
 * DISCLAIMER:
 * Not my idea to have this weird distinction of coded vs. named (i.e. non-coded) substances,
